...
const SocialLinks = () => {
  const links = [
    ...
    },
    {
      ...
      href: "https://github.com/anadi2311",
    },
    {
      id: 3,
      child: (
      ...
      href: "mailto:anadi.pandharkar5@gmail.com",
    },
    {
      id: 4,
      child: (
        <>
          Mail <FaTwitter size={30} />
        </>
      ),
      href: "https://twitter.com/anadipandharkar",
    },
    {
      id: 5,
      child: (
        <>
          Resume <BsFillCloudArrowDownFill size={30} />
        </>
      ),
      href: "/resume.pdf",
      style: "rounded-br-md",
